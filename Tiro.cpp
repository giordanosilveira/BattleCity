...
Tiro::Tiro(const unsigned int x, const unsigned int y, const unsigned short int tamanhoSprite, const unsigned short int velocidade, const unsigned short int direcao):
    Objeto{x,y,tamanhoSprite}{
